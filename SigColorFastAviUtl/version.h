#ifndef SIG_VERSION_H_
#define SIG_VERSION_H_
#define SIG_COLOR_VERSION  0,3,0
#define SIG_COLOR_VERSION_STR "0.3.0"
#ifdef _DEBUG
#   define SIG_COLOR_AUF_INFO         "SigColorFastAviUtl(DEBUG)"
#else
